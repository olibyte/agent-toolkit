...
Once all explorers have returned, spawn one subagent to synthesize. Same constraints as 2b. Build its prompt from `references/explainer-prompt.md` with every explorer's findings filled in.
