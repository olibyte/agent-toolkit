...
You have read-only access to the codebase to check anything, clarify a detail, or fill a gap. Search and read the codebase as needed. Do not re-explore from scratch.
