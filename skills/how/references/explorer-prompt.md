...
Start by finding the relevant code. Find directories and files by name pattern. Search file contents for key symbols. Read the files to understand the actual implementation. Don't guess from names. Read the code.
