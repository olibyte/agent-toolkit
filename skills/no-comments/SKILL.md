...
Codex `$no-comments`. Claude Code, Cursor, and Antigravity `/no-comments`.
...
1. Spawn a subagent. Give it `references/comment-sicko.md` as its instructions, plus the scope. Do not restate its rules in the parent prompt.
