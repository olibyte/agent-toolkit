...
Use this reference when the Babysit playbook (`../playbooks/babysit.md`) handles Bugbot or other automated review comments. The goal is not to ignore Bugbot by default. The goal is to stop treating every comment as a required code change.
